...
The files are included directly from \texttt{src/} at render time.
...
\section{\texorpdfstring{\texttt{dependencies.json}}{dependencies.json}}\label{dependencies.json}

\VerbatimInput[breaklines=true,breakanywhere=true,fontsize=\scriptsize,numbers=left,frame=single,tabsize=2]{../src/dependencies.json}

\newpage

\section{\texorpdfstring{\texttt{make\_replication\_code\_pdf.R}}{make\_replication\_code\_pdf.R}}\label{make_replication_code_pdf.r}

\VerbatimInput[breaklines=true,breakanywhere=true,fontsize=\scriptsize,numbers=left,frame=single,tabsize=2]{../src/make_replication_code_pdf.R}

\newpage

\section{\texorpdfstring{\texttt{README.md}}{README.md}}\label{readme.md}

\VerbatimInput[breaklines=true,breakanywhere=true,fontsize=\scriptsize,numbers=left,frame=single,tabsize=2]{../src/README.md}
