...
// Generate shorter variable name
gen d_tr_usch_netinpw = d_tradeusch_netinput_pw

eststo clear
eststo: ivregress 2sls d_sh_empl_mfg (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip) first
eststo: ivregress 2sls d_sh_empl_nmfg (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls d_avg_lnwkwage_mfg (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls d_avg_lnwkwage_nmfg (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls lnchg_trans_totindiv_pc (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls relchg_avg_hhincwage_pc_pw (d_tr_usch_netinpw=d_tradeotch_pw_lag d_inputotch_pw_lag) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
...
// Generate shorter variable name
gen d_nettrf_uschio = d_nettradefactor_usch_io

eststo clear
eststo: ivregress 2sls d_sh_empl_mfg (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip) first
eststo: ivregress 2sls d_sh_empl_nmfg (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls d_avg_lnwkwage_mfg (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls d_avg_lnwkwage_nmfg (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls lnchg_trans_totindiv_pc (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
eststo: ivregress 2sls relchg_avg_hhincwage_pc_pw (d_nettrf_uschio=d_tradefactor_otch_lag_io d_expfactor_otch_lag_io) reg* l_shind_manuf_cbp l_sh_popedu_c l_sh_popfborn l_sh_empl_f l_sh_routine33 l_task_outsource t2 [aw=timepwt48], cluster(statefip)
