...
We verify that the official replication package functions correctly. Our target is Table 3 of @autorDornHanson2013, the 2SLS regression of CZ-level change in manufacturing employment share on $\Delta IPW_{uit}$, instrumented by the eight-country measure. We focus on column (6) with full controls.
