...
OLS estimation of the labor-market effect of Chinese import exposure faces an endogeneity problem. Observed U.S. imports reflect both Chinese supply-side and U.S. demand shocks, biasing OLS toward zero. ADH (2013) report an OLS estimate of −0.171 versus an IV estimate of −0.596 [@autorDornHanson2013].
...
where $X_{it}$ contains start-of-period manufacturing share, demographic controls, the routine and offshorability indices of Autor and Dorn (2013), and Census division dummies [@autorDorn2013].
